...
export default function CNCOrderForm() {
  const [selectedTab, setSelectedTab] = useState('CNC Machining');
  ...
  const tabs = ['CNC Machining', 'Laser Cutting', '3D Designing'];
  const materials = ['MS Steel', 'Aluminium', 'Copper', 'Plastic'];
